...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(2, 3532822060141359030),
      name: 'Owner',
      lastPropertyId: const IdUid(2, 1604899911481170742),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8886612925047811299),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1604899911481170742),
            name: 'name',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(3, 2311216649786812927),
      name: 'Task',
      lastPropertyId: const IdUid(5, 2496713060656318386),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 364639472362983315),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 4579307060148686584),
            name: 'text',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2461361083498961244),
            name: 'status',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 991596781327272397),
            name: 'ownerId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 8807653700363644071),
            relationTarget: 'Owner'),
        ModelProperty(
            id: const IdUid(5, 2496713060656318386),
            name: 'eventId',
            type: 11,
            flags: 520,
            indexId: const IdUid(2, 7167916510844834380),
            relationTarget: 'Event')
      ],
      relations: <ModelRelation>[],
      backlinks: <ModelBacklink>[]),
  ModelEntity(
      id: const IdUid(4, 5311164796426293705),
      name: 'Event',
      lastPropertyId: const IdUid(5, 500480110764703515),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 341827923517188282),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8294694390091340949),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 1422401874460204402),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 4324264113049967510),
            name: 'date',
            type: 10,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 500480110764703515),
            name: 'location',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(4, 5311164796426293705),
      lastIndexId: const IdUid(2, 7167916510844834380),
      lastRelationId: const IdUid(0, 0),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [3033719814079657485],
...
class Event_ {
  ...
  static final description =
      QueryStringProperty<Event>(_entities[2].properties[2]);

  /// see [Event.date]
  static final date = QueryIntegerProperty<Event>(_entities[2].properties[3]);
